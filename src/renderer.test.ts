...
import {inputNode, inputGroup, inputEdge, expectedNode, expectedEdge} from './test_utils';
...
describe('renderer', () => {
  ...
  it('configures cytoscape to render a diagram', () => {
    ...
    const expectedElements = {
      nodes: [
        expectedNode({id: 'dns', service: 'route53', provider: 'aws'}),
        expectedNode({id: 'cf', label: 'CDN', service: 'cloudfront', provider: 'aws', attributes: {label: 'CDN'}}),
        expectedNode({id: 'vpc', provider: undefined, service: undefined, attributes: {fill: 'green'}, classes: ''}),
        expectedNode({id: 'load_balancer', service: 'elasticLoadBalancing', provider: 'aws', parent: 'vpc'}),
        expectedNode({id: 'servers', provider: undefined, service: undefined, parent: 'vpc', classes: ''}),
        expectedNode({id: 'server1', service: 'ec2', provider: 'aws', parent: 'servers'}),
        expectedNode({id: 'server2', service: 'ec2', provider: 'aws', parent: 'servers'}),
      ],
      edges: [
  ...
  it('automatically creates nodes for unknown edge targets', () => {
    ...
    const expectedElements = {
      nodes: [
        expectedNode({id: 'dns', service: 'route53', provider: 'aws'}),
        expectedNode({id: 'cf', label: 'CDN', provider: 'aws', service: 'cloudfront', attributes: {label: 'CDN'}}),
        expectedNode({id: 'vpc', provider: undefined, service: undefined, attributes: {fill: 'green'}, classes: ''}),
        expectedNode({id: 'load_balancer', service: 'elasticLoadBalancing', provider: 'aws', parent: 'vpc'}),
        expectedNode({id: 'unknown', label: 'unknown', provider: 'generic', service: 'generic'}),
      ],
  ...
  it('sets the diagram direction correctly', () => {
    ...
    const expectedElements = {
      nodes: [expectedNode({id: 'dns', service: 'route53', provider: 'aws'})],
      edges: [],
    };
  ...
  it('respects empty labels', () => {
    ...
    const expectedElements = {
      nodes: [expectedNode({id: 'dns', label: '', service: 'route53', provider: 'aws', attributes: {label: ''}})],
      edges: [],
    };
